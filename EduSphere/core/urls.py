...
urlpatterns = [
    ...
    path('u-admin/departments/<int:pk>/delete/', views.DepartmentDeleteView.as_view(), name='department_delete'),
    ...
    path('u-admin/students/bulk-register/', views.StudentBulkRegistrationView.as_view(), name='student_bulk_register'),
    path('u-admin/students/<int:pk>/update/', views.StudentUpdateView.as_view(), name='student_update'),
    path('u-admin/students/<int:pk>/delete/', views.StudentDeleteView.as_view(), name='student_delete'),
    ...
    path('u-admin/faculty/<int:pk>/update/', views.FacultyUpdateView.as_view(), name='faculty_update'),
    path('u-admin/faculty/<int:pk>/delete/', views.FacultyDeleteView.as_view(), name='faculty_delete'),
    ...
    path('courses/<int:course_pk>/subjects/create/', views.SubjectCreateView.as_view(), name='subject_create'),
    path('subjects/<int:pk>/update/', views.SubjectUpdateView.as_view(), name='subject_update'),
    path('subjects/<int:pk>/delete/', views.SubjectDeleteView.as_view(), name='subject_delete'),
    path('courses/<int:course_pk>/enroll/', views.EnrollStudentView.as_view(), name='enroll_student'),
    path('unenroll/<int:pk>/', views.UnenrollStudentView.as_view(), name='unenroll_student'), 
    path('courses/<int:course_pk>/bulk-enroll/', views.StudentBulkEnrollmentView.as_view(), name='student_bulk_enroll'),
    ...
    path('student/subjects/<int:pk>/', views.StudentSubjectDetailView.as_view(), name='student_subject_detail'),
    ...
    path('quizzes/<int:pk>/upload-questions/', views.QuizQuestionBulkUploadView.as_view(), name='quiz_bulk_upload'),
]
